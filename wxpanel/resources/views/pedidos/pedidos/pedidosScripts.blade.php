<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        var resourceTable = $('#' + resourceTableId).dataTable({
            ...
            "sDom" : "<'dt-top-row'Tl <'filtro-custom'f><'filtro-mas filtro-all dataTables_length2'><'filtro-mas filtro-meli dataTables_length2'><'btn-filters'>>r<'dt-wrapper't><'dt-row dt-bottom-row'<'row'<'col-sm-6'i><'col-sm-6 text-right'p>>>",
           "oTableTools" : {
             "aButtons" : [{
              "sExtends" : "collection",
            ...
            "initComplete": function ()
            {
				...
				$(dtWrapper + '.filtro-meli select[name='+ selectName +']').on('change', onChangeFiltroMas8);
            ...
            "aoColumnDefs": [
				...
				{ "mData": "precio_venta", "aTargets":[11], "sortable":false, "visible":false },
				{ "mData": "stock_reserva", "aTargets":[12], "sortable":false, "mRender": 
					function(value, type, full){
				...
				{ "mData": "notificaciones", "aTargets":[13], "sortable":false, "mRender": 
					function(value, type, full){
