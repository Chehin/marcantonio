        ...
        <div class="row">
                ...
                <article class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                        ...
                        <div class="jarviswidget jarviswidget-color-blueDark" id="wid-id-2" data-widget-editbutton="false" data-widget-deletebutton="true">
                                ...
                                <div>
					<section>
						<form class="smart-form" action="{{ route('productos/importarProductosMeliProcesar') }}" method="post" enctype="multipart/form-data">
							{{ Form::token() }}
...
@section('custom_scripts_container')
	@include('productos.importarProductosMeli.importarProductosMeliScripts')
@stop
