    ...
    $(document).ready(function() {
        ...
        var resourceTable = $('#' + resourceTableId).dataTable({
            ...
            "initComplete": function ()
            {
				...
				//end filtro Stock
				//filtro mas
				var $selectMas = $('<select><option value="NULL" seleted="true">Filtrar</option><option value="1">Con Foto</option><option value="2">Sin Foto</option><option value="3">Destacados</option><option value="4">Ofertas</option><option value="5">En Mercado Libre</option><option value="6">Habilitados</option><option value="7">Deshabilitados</option></select>');
...
/*				var $selectHabilitado = $('<select><option value="NULL" seleted="true">Filtrar Habilitado</option><option value="1">Habilitado</option><option value="0">Deshabilitado</option></select>');
				$('.filtro-mas').append($selectHabilitado);
				//filtro habilitados
				$selectHabilitado.change(function(){
					resourceTable.dataTable().fnFilter($(this).val(),7);
				});*/
				//end filtro habilitados
			...
			{ "mData": "destacado", "visible": true, "aTargets":[8], "sortable":false, "mRender": function(value, type, full){
				var prefix = '1';
			...
			{ "mData": "oferta", "visible": true, "aTargets":[9], "sortable":false, "mRender": function(value, type, full){
				var prefix = '2';
				var resourceTableId = prefix + '_' + resourceTableId;
			...
			{ "mData": "comentarios", "visible": false, "aTargets":[12], "sortable": true, "mRender": function(value, type, full){
				var prefix = '3';
				var resourceTableId = prefix + '_' + resourceTableId;
				var checked = ( 1 == full.comentarios) ? 'checked' : '';
			...
			{ "mData": "id_meli", "visible": true, "aTargets":[13], "sortable":false, "mRender": function(value, type, full){
				var meli = '';
			...
			{ "mData": "id_meli", "visible": true, "aTargets":[14], "sortable":false, "sClass": "center", "mRender": function(value, type, full){
				var preguntas = '';
				if (value) {
					preguntas = '<a href="javascript:;" ><span data-href="'+resourceReqOption6.edit.url(full.id)+'" data-toggle="modal-custom" style="font-size: 120%;"">Ver</span></a>';
				}
				return preguntas;
			}
			},
