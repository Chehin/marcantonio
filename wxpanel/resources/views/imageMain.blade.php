    ...
    <div class="modal-content">
        <div class="modal-header">
            ...
            <h6 class="modal-title" id="myModalLabel">
				<i class="fa fa-picture-o fa-fw "></i> {{$aViewData['resourceLabel']}} <span>> Imágenes</span><span> > "{{ ($item && $itemNameField) ? App\AppCustom\Util::truncateString($itemNameField, 50) : "" }}"</span>
			</h6>
        </div>
		<!-- NEW WIDGET START -->
		<article>
