...
class PedidosBackupUtilController extends GenericUtilController
{
    public function __construct(PedidosBackupController $res) {
		...
		$this->aCustomViewData['aMetPago'] = Util::getEnum('pedidos_pedidos_backup', 'metodo_pago');
