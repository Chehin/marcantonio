...
class Controller extends BaseController
{
    ...
    public function view_ready($api){        
		...
		try {			
            ...
            $postg = http_build_query($array_sendg);
            $etiquetas_rubros = $api->client->resJson('GET', 'panelGeneros?'.$postg)['data'];

             view()->share( 'menu_web', $menu['data']);
            view()->share( 'etiquetas_rubros',$etiquetas_rubros);
      //  dd($menu['data']['rubros'][1]['subrubros']);
